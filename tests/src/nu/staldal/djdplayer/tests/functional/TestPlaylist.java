...
package nu.staldal.djdplayer.tests.functional;
...
import nu.staldal.djdplayer.tests.MusicPlayerNames;
import nu.staldal.djdplayer.MusicUtils;
import nu.staldal.djdplayer.PlaylistBrowserActivity;
...
public class TestPlaylist extends ActivityInstrumentationTestCase<PlaylistBrowserActivity> {
    ...
    public TestPlaylist() {
        super("nu.staldal.djdplayer", PlaylistBrowserActivity.class);
    }
    ...
    public void addNewPlaylist(String playListName) throws Exception {
        ...
        ActivityMonitor trackBrowserMon = inst.addMonitor("nu.staldal.djdplayer.TrackBrowserActivity",
                null, false);
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_PICK);
        intent.setClassName("nu.staldal.djdplayer", "nu.staldal.djdplayer.TrackBrowserActivity");
    ...
    /**
     * Test case 1: Add a playlist and deletw the playlist just added.
    ...
    public void testDeletePlaylist() throws Exception {
        ...
        result = verifyPlaylist(MusicPlayerNames.DELETE_PLAYLIST_NAME);
        assertFalse("testDeletePlaylist", result);
    }
    ...
    public void testRenamePlaylist() throws Exception {
        ...
        result = verifyPlaylist(MusicPlayerNames.RENAMED_PLAYLIST_NAME);
        deletePlaylist(MusicPlayerNames.RENAMED_PLAYLIST_NAME);
        assertTrue("testRenamePlaylist", result);
    }
